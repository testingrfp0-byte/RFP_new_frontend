    ...
    return (
        <div
            className={`rounded-lg overflow-hidden ${isDarkMode
                ? question.submit_status === "submitted"
        ...
        >
            ...
            >
                <div className="flex items-start gap-3 flex-1">
                    ...
                    <span className={`font-medium text-sm ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                        {question.question_text.substring(question.question_text.indexOf(" ") + 1)}
                    </span>
                </div>
            ...
            {expandedQuestion === idx && (
                <div className={`p-4 border-t ${isDarkMode ? "bg-gray-750 border-gray-600" : "bg-gray-100 border-gray-200"}`}>
                    <div className="mb-4">
